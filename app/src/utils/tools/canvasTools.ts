        ...
        properties: {
          ...
          commands: {
            ...
            description: [
              ...
              '    Adds a header text + N note cards vertically on an existing slide. No x/y math needed.',
              ...
              'WORKFLOW TIPS: (1) Same bg+theme on all slides → ONE call: apply_theme with bg_color/bg_url + text_color + to_slides:"all". (2) Template slide → duplicate_slide is 1 call instead of N add_* calls. (3) Rename slide → update with id=frameId and text="New name". (4) Fix text colors after bg change → recolor_slide. (5) Creating a full lesson/course → use create_lesson in ONE call instead of N add_slide + N add_note calls. (6) Adding bullets to a slide → use add_bullet_list instead of N add_note calls with manual y coords.',
            ].join('\n'),
          },
        },
